...
module KoronaHelpe
  ...
  def create_k_product(params)
    ...
    #     }
    # }
    url = "https://167.koronacloud.com/web/api/v3/accounts/#{koronaAccountId}/products"
  ...
  #   res = HTTParty.patch(url, headers: korona_headers, body: JSON.dump(payload)).parsed_response
  #   if res
  #       puts "Store order Product updated successfully"
  #       return res
  #   else
  #       puts "STORE ORDER update product api request fails", res
  #       return nil
  #   end
  # end
